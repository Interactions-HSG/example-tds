...
public class InteractionsLabReal extends Thing {

  public InteractionsLabReal(String baseURI, String relativeURI, String title) {
    ...
    PropertyAffordance readStatus = new PropertyAffordance.Builder("Status", readStatusForm)
            ...
            .addDataSchema(new ObjectSchema.Builder()
                    ...
                    .addProperty("Sunshine", new NumberSchema.Builder()
                            ...
                            .build())
                    .addProperty("EnergyCost", new NumberSchema.Builder()
                            .addSemanticType("http://example.org/was#EnergyCost")
                            .build())
                    .addProperty("TotalEnergyCost", new NumberSchema.Builder()
                            .addSemanticType("http://example.org/was#TotalEnergyCost")
                            .build())
                    .build())
            .build();
